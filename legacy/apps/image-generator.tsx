...
//       id: "welcome",
//       content:
//         "Hello! Describe what image you'd like to create, or upload a reference image to get started.",
//       sender: "assistant",
//       timestamp: "Just now",
//     },
//   ]);
...
//   // Close sidebar automatically on mobile when selecting an option
//   React.useEffect(() => {
//     if (isMobile && sidebarOpen) {
//       setSidebarOpen(false);
//     }
//   }, [selectedStyle, isMobile, sidebarOpen]);
...
//               <h1 className="text-xl font-bold truncate">AI Image Generator</h1>
//             </div>
//             <Separator />
//           </SidebarHeader>
...
//             </div>
//             <div className="flex items-center gap-2">
//               {/* On mobile, make chat button smaller */}
//               <Button
//                 variant="outline"
...
//               {/* On mobile, make select dropdown more compact */}
//               <TooltipProvider>
//                 <Select value={selectedModel} onValueChange={setSelectedModel}>
//                   <SelectTrigger
//                     className={isMobile ? "w-[120px] text-xs" : "w-[240px]"}
//                   >
...
//             {/* Main generator area - layout changes based on device and chat visibility */}
//             <div
//               className={`
//                 ${
//                   isMobile
...
//                   {generatedImage && (
//                     <div className="space-y-4">
//                       <div className="relative aspect-square overflow-hidden rounded-lg border max-w-lg mx-auto">
//                         <img
...
//             {/* Chat Section - Conditionally rendered and adapts to screen size */}
//             {showChat && (
//               <div
//                 className={`${
//                   isMobile ? "h-1/2 border-t" : "w-1/3 border-l"
//                 } flex flex-col`}
//               >
